                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                        {Object.keys(models)
                            ...
                            .map((key) => (
                                <button 
                                    key={key} 
                                    onClick={() => props.transcriber.setModel(key)}
                                    className={`px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 ${props.transcriber.model === key ? 'bg-gray-100' : ''}`}
                                >
                                    {`${key}${
                    ...
                    <div className='flex justify-between items-center mb-3 px-1'>
                        <div className='flex items-center'>
                            <input
                                ...
                                onChange={(e) => {
                                    setMultilingual(e.target.checked);
